...
Here, there is a deviation from the ggplot framework in the home page. "bins" is used to tell R how many bars to create in your histogram. You can change this number as needed.
